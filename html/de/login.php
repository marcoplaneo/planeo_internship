...
?>
    ...
    <div class="main">
        <form method="post">
            <br><br>
            <label>Benutzername: <br><input type="text" id="username" name="username" required></label>
            <br><br>
            <label>Passwort: <br><input type="password" id="password" name="password" required></label>
            <br><br>
            <button type="submit" class="button" name="LogIn">Einloggen</button>
        </form>
    </div>
    </body>
    </html>
...
if (isset($_POST["LogIn"])) {
    ...
    if (empty($username)) {
        echo "<br> Bitte geben Sie einen Benutzernamen ein!";
    } elseif (empty($password)) {
        echo "<br> Bitte geben Sie ein Passwort ein!";
    } else {
        //hash the password
        ...
        if (mysqli_num_rows($usernameresult) > 0) {
            ...
            echo "<br> Dieser Benutzer existiert nicht";
        }
    }
}
mysqli_close($con);
