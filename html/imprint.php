...
<div class="main">
    ...
    <p>
        Sales tax identification number according to §27 a Umsatzsteuergesetz: DE324686663
    </p>
    <h3>Dispute resolution</h3>
    <p>
        The European Commission provides a platform for online dispute resolution (OS):
        https://ec.europa.eu/consumers/odr.
        You can find our e-mail address in the imprint above. We are not willing or obliged to participate in dispute
    ...
    <p>
        ...
        under the general laws. According to §§ 8 to 10 TMG we are not obligated to monitor transmitted or stored
        information or to investigate circumstances that indicate illegal activity. Obligations to remove or block the
        use of information under the general laws remain unaffected. However, liability in this regard is only possible
        from the point in time at which a concrete infringement of the law becomes known. If we become aware of any such
    ...
    <p>
        ...
        a violation of the law. If we become aware of any infringements, we will remove such links immediately.
    </p>
    <h3>Copyright</h3>
    <p>
...
<div class="footer">
    ...
    <script>
        function changeLanguage(lang) {
            location.hash = lang;
            location.href = "./de/impressum.php";
        }
    </script>
</div>
</body>
